"""
Django settings for mute_tooth_42806 project.
...
ROOT_URLCONF = 'mute_tooth_42806.urls'
...
WSGI_APPLICATION = 'mute_tooth_42806.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mute_tooth_42806 API",
    "DESCRIPTION": "API documentation for mute_tooth_42806 App",
    "VERSION": "v1",
}
